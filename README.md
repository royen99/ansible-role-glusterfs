...
Role for installing GlusterFS on the target systems

## Requirements

Ansible inventory must contain three (3) RHEL/CentOS/Rocky/Alma nodes within the network (or at least be able to communicate freely)
...
[Nico van Roijen](mailto:dutch.it@gmail.com)
